...
function LoginScreen({ onLoggedIn }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "system-ui, sans-serif", background: "#F7F5EF" }}>
      <form onSubmit={handleSubmit} style={{ background: "#fff", padding: 32, borderRadius: 16, width: 320, boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
        <h2 style={{ marginTop: 0, color: "#159E93" }}>Home Doctor Ibarra</h2>
        <p style={{ fontSize: 13, color: "#8A8577", marginTop: -8 }}>Inicia sesión para continuar</p>
